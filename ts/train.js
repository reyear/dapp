...
function fileinput_init(obj){
    obj.fileinput({
        showPreview: false,
        showUpload: false,
        uploadUrl: 'https://10.1.13.100:8002/pmht/postFile',
    });
        ...
        methods:{
            ...
            showModelRes(jobid){
                ...
                if(
                    ...
                    inputZip_url = 'https://10.1.13.100:8002/api/histories/'+ history_Id + '/contents/' + res.outputs.input.id +'/display?key=' + key;
                ...
                if(
                    ...
                    wf_url = 'https://10.1.13.100:8002/api/histories/'+ history_Id + '/contents/' + res.outputs.workinfo.id +'/display?key=' + key;
                ...
                if(
                    ...
                    var _url = 'https://10.1.13.100:8002/api/histories/'+ history_Id + '/contents/' + res.outputs.pic.id +'/display?key=' + key;
                ...
                if(
                    ...
                    var _url = 'https://10.1.13.100:8002/api/histories/'+ history_Id + '/contents/' + res.outputs.predict.id +'/display?key=' + key;
